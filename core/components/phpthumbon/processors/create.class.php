...
class CreateThumbProcessor extends modProcessor
{
    ...
    public function initialize()
    {
        ...
        if (!isset($this->modx->phpThumbOn)) {
            ...
            $this->modx->phpThumbOn = $this->modx->getService("phpthumbon", "phpThumbOn", $this->_cfg['modelPath'] . 'phpthumbon/',
                $this->getProperties());
        }
    ...
    {
        $this->_data = $flag = $this->modx->getObject("ThumbImages", array('isend' => 0));
