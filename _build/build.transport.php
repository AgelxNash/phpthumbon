...
$modx->log(modX::LOG_LEVEL_INFO,'Packaged core folder.'); flush();
$vehicle->resolve('file',array(
    'source' => $sources['source_assets'],
    'target' => "return MODX_ASSETS_PATH . 'components/';",
));
$modx->log(modX::LOG_LEVEL_INFO,'Packaged assets folder.'); flush();
$vehicle->resolve('php', array(
    'source' => $sources['resolvers'] . 'dbchanges.resolver.php',
));
$modx->log(modX::LOG_LEVEL_INFO,'Packaged resolvers.'); flush();

$builder->putVehicle($vehicle);
$modx->log(modX::LOG_LEVEL_INFO,'Packaged snippet.'); flush();
...
$modx->log(modX::LOG_LEVEL_INFO,'Packaged '.count($settings).' System Settings.'); flush();
